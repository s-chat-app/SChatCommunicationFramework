package indi.midreamsheep.schatapp.frame.net.protocol.resonse.data.result.chat;

import indi.midreamsheep.schatapp.frame.net.protocol.resonse.data.result.ResultData;
